...
// extra edit
$parsedUrl = parse_url($_GET['src']);


// YAY!Scripting edit:
// Test if a specific variable is set, for safety purposes
if (!defined('LOAD') && (empty($parsedUrl) || $parsedUrl['hostname'] == $_SERVER['SERVER_NAME']))
	die;
